...
const site = unwrapEnvVar('SITE_URL', 'https://github.com/MathewKioko/WebChecker');
...
console.log(
  `\n\x1b[1m\x1b[35m Preparing to start build of Web Checker.... \x1b[0m\n`,
  ...
  `https://github.com/MathewKioko/WebChecker \n`,
  `💖 Found Web Checker useful? Consider sponsoring us on GitHub ` +
