...
const About = (): JSX.Element => {
  ...
  return (
    ...
    <AboutContainer>
      <Nav>
        <HeaderLinkContainer>
          <a target="_blank" rel="noreferrer" href="https://github.com/MathewKioko/WebChecker"><Button>View on GitHub</Button></a>
        </HeaderLinkContainer>
      </Nav>
      ...
      <Section>
        ...
        <hr />
        <p>
          Web-Check is developed and maintained by <a target="_blank" rel="noreferrer" href="https://github.com/MathewKioko">Mathew Kioko</a>.
          ...
          Source code and self-hosting docs are available on <a target="_blank" rel="noreferrer" href="https://github.com/MathewKioko/WebChecker">GitHub</a>.
          If you've found this service useful, consider <a target="_blank" rel="noreferrer" href="https://github.com/sponsors/MathewKioko">sponsoring me</a> from $1/month,
      ...
      <Section>
        ...
        <a target="_blank" rel="noreferrer" href="https://app.netlify.com/start/deploy?repository=https://github.com/MathewKioko/WebChecker">
        ...
        <a target="_blank" rel="noreferrer" href="https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2FMathewKioko%2FWebChecker&project-name=web-checker&repository-name=web-checker-fork&demo-title=Web-Checker%20Demo&demo-description=Check%20out%20github.com%2FMathewKioko%2FWebChecker%20to%20see%20a%20live%20demo%20of%20this%20application%20running.&demo-url=https%3A%2F%2Fgithub.com%2FMathewKioko%2FWebChecker&demo-image=https%3A%2F%2Fraw.githubusercontent.com%2FMathewKioko%2FWebChecker%2Fmaster%2F.github%2Fscreenshots%2Fweb-check-screenshot10.png">
          <img src="https://vercel.com/button" alt="Deploy with Vercel" />
        </a>

        <Heading as="h3" size="small" color={colors.primary}>Option #3 - Docker</Heading>
        <p>
        A Docker container is published to <a target="_blank" rel="noreferrer" href="https://hub.docker.com/r/mathewkioko/web-checker">DockerHub</a>
        <br />
        Run this command, then open <code>localhost:3000</code>
        <pre>docker run -p 3000:3000 mathewkioko/web-checker</pre>
        </p>

        <Heading as="h3" size="small" color={colors.primary}>Option #4 - Manual</Heading>
        <pre>
        git clone https://github.com/MathewKioko/WebChecker.git<br />
        cd WebChecker # Move into the project directory<br />
        ...
        <p>
          ...
          GitHub repository - <a target="_blank" rel="noreferrer" href="https://github.com/MathewKioko/WebChecker#readme">github.com/MathewKioko/WebChecker</a>
        </p>
      ...
      <Heading as="h3" size="small" color={colors.primary}>License</Heading>
        <b>
          <a target="_blank" rel="noreferrer" href="https://github.com/MathewKioko/WebChecker">Web Checker</a> is distributed under the MIT license,
          © <a target="_blank" rel="noreferrer" href="https://github.com/MathewKioko">Mathew Kioko</a> { new Date().getFullYear()}
        </b>
        <br />
